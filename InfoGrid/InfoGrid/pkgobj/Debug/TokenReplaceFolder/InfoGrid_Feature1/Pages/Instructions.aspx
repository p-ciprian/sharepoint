...
<asp:Content ContentPlaceHolderID="PlaceHolderMain" runat="server">
    <div class="container">
        <p>Info Grid add-in is a very simple SharePoint solution that can be used to display an animated information panel. The add-in uses the MegafolioPro jquery plugin to display the information as a grid of animted tiles. </p>
        <h2>Adding Content</h2>
        <p>
            The "Add Content" hyperlink on the main page will open the "Info Grid List", this hyperlink is only visible to the users that have contribute permissions to this list.
            The "Info Grid List" list permissions are inherited from the host web application.
        </p>
                <p>
            <img  alt="" src="../Images/3.png" />
        </p>
        <p>
            To add new content you can just click "new item" link in the "Info Grid List" default page. You will be presented a page where to fill-in the Title and the Contents fields.
        ...
        <p>You can restrict the visibility of an individual tile by selecting the corresponding list item in the Info Grid List, removing the role inheritance and assign unique permissions.(e.g. using the grid to display the company’s benefits, allowing the tiles to be visible to all except three tiles that are only visible to the Finance department).</p>
        <h2>Configuration</h2>
        <p>
            The Info Grid add-in allows few basic customizations.
      <br />
            The settings are stored as key-value pairs in the "Settings" list. The "Settings" list can be accessed from the main page of Info Grid add-in. The "Settings" link is only visible to the users that have contribute permissions for the list.
        </p>
        <p>
        ...
        <h4>Grid layout</h4>
        <p>
            The Info Grid add-in uses the MegafolioPro jquery plugin to generate the animated tiles.The layout of the grid can be changed by specifying a layout number which which can be found by accessing the MegafolioPro documentation: 
