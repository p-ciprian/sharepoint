...
<head>
    ...
    <meta name="description" content="Information Panel">
...
<body>
    ...
    <div class="infogrid-view-port">
        ...
        <div class="no-items-page" style="color:white;font-size:18px;">
            The Information Panel List is currently empty,  <button class="infogrid-button admin-button" type="button" onclick="navigateToList()" style="font-size:18px;">Click Here</button>  to add new content.
