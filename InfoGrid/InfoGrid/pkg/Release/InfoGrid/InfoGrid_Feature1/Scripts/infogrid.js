    ...
    function getinfogrid() {
        ...
        $.ajax({
            ...
            complete: function (data) {
                ...
                $.ajax({
                    url: appweburl + "/_api/lists/getByTitle('Information Panel List')/items?$select=Title,Contents,Attachments,AttachmentFiles&$expand=AttachmentFiles",
                    method: "GET",
                    headers: { "Accept": "application/json; odata=verbose" },
                    success: function (data) {
                        if (data.d.results.length > 0) {
        ...
        $.ajax({
            url: appweburl + "/_api/web/lists/getByTitle('Information Panel List')/effectiveBasePermissions",
            method: "GET",
            headers: { "Accept": "application/json; odata=verbose" },
            success: function (data) {
